...
const FAQ_ITEMS = [
  {
    q: '사전등록은 어떻게 하나요?',
    a: '위쪽 사전등록 카드에서 네이버로 로그인한 뒤, 필수 항목에 동의하고 "사전등록하기"를 누르면 끝나요. 추천해준 친구가 있다면 친구의 이메일도 함께 입력해주세요.',
  },
  {
    q: '누가 참여할 수 있나요?',
  ...
  {
    q: '어떤 상품을 받을 수 있나요?',
    a: '선착순 1명과 랜덤 번호 1명에게 50,000원 기프티콘을, 추천을 가장 많이 받은 1명에게 30,000원 상당의 상품을 드려요. 기프티콘 브랜드는 상품 안내에서 볼 수 있어요.',
  },
  {
    q: '당첨되면 어떻게 알 수 있나요?',
  ...
  {
    q: '추천인은 어떻게 입력하나요?',
    a: '나를 추천한 친구가 사전등록할 때 쓴 네이버 이메일을 입력하면 돼요. 친구가 먼저 사전등록을 마친 상태여야 하고, 입력은 선택이에요.',
  },
  {
    q: '제 개인정보는 언제 삭제되나요?',
